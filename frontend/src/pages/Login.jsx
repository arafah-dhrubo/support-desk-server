...
const Login = () => {
  ...
  return (
    <section className="bg-blue-50 w-full h-screen flex flex-col justify-center items-center py-5">
      <div className="bg-white w-2/6 p-10 mx-auto rounded">
        <h1 className="text-4xl font-bold text-center">Login Account</h1>
        ...
        <p className="text-gray-600 my-3 text-center font-semibold">New here? <Link to="/register" className="text-blue-600">Create Account</Link></p>
